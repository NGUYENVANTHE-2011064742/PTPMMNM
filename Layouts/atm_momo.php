...
$amount = "10000";
$orderId = time() . "";
$redirectUrl = "http://localhost:3000/index.php?action=thongbao";
$ipnUrl = "http://localhost:3000/index.php?action=thongbao";
$extraData = "";
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class='input-group date' id='fxRate'>
                                            <input type='text' type="text" name="extraData"
                                                value="<?php echo $extraData ?>" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
