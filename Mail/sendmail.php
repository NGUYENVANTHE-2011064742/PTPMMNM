...
function sendEmail($toEmail, $toName, $subject, $body) {
    ...
    try {
        ...
        $mail->SMTPAuth   = true;
        $mail->Username   = 'bilakmkiss@gmail.com'; // Tên đăng nhập SMTP của bạn
        $mail->Password   = 'iwstnxcjpnzhgnek'; // Mật khẩu SMTP của bạn
        ...
        $mail->setFrom('bilakmkiss@gmail.com', 'Nguyễn Văn Thế'); // Địa chỉ email của bạn và tên bạn muốn hiển thị
...
// Gọi hàm gửi email
$toEmail = 'nguyenvanthe30032002@gmail.com';
